...
a.races.ward5.pollsReporting+a.races.adsb_ward1.pollsReporting+a.races.adsb_ward2.pollsReporting+a.races.adsb_ward3.pollsReporting+a.races.adsb_ward4.pollsReporting+a.races.adsb_ward5.pollsReporting+a.races.adsb_unorganized.pollsReporting+a.races.hscdsb.pollsReporting+a.races.cscno.pollsReporting+a.races.cspgno.pollsReporting;a=a.races.mayor.pollsTotal+a.races.ward1.pollsTotal+a.races.ward2.pollsTotal+a.races.ward3.pollsTotal+a.races.ward4.pollsTotal+a.races.ward5.pollsTotal+a.races.adsb_ward1.pollsTotal+
a.races.adsb_ward2.pollsTotal+a.races.adsb_ward3.pollsTotal+a.races.adsb_ward4.pollsTotal+a.races.adsb_ward5.pollsTotal+a.races.adsb_unorganized.pollsTotal+a.races.hscdsb.pollsTotal+a.races.cscno.pollsTotal+a.races.cspgno.pollsTotal;document.getElementById("progress-bar--pollsReporting_sum").style.width=(b/a*100).toString()+"%";for(b=0;b<m.length;b+=1)q(m[b])}).fail(function(){try{window.alert("An error occurred retrieving the results.")}catch(a){}})};document.getElementById("siteContainer").style.display=
"block";b();g&&window.setInterval(b,61E3);var k=document.getElementById("tabsContainer--toggleBtn"),c=document.getElementById("tabsContainer"),n=function(){c.classList.add("d-none");k.setAttribute("aria-expanded","false")},p=function(){var a=c.getElementsByClassName("active")[0].getAttribute("data-next-tab");document.getElementById(a).click()};k.addEventListener("click",function(){c.classList.contains("d-none")?(c.classList.remove("d-none"),k.setAttribute("aria-expanded","true")):n()});$("a[data-toggle='tab']",
c).on("shown.bs.tab",n);for(var e=document.getElementsByClassName("tabsContainer--prevBtn"),b=0;b<e.length;b+=1)e[b].addEventListener("click",function(){var a=c.getElementsByClassName("active")[0].id;c.querySelector("a[data-next-tab='"+a+"']").click()});e=document.getElementsByClassName("tabsContainer--nextBtn");for(b=0;b<e.length;b+=1)e[b].addEventListener("click",p);var r=document.getElementById("option-autoTab");window.setInterval(function(){r.checked&&p()},45E3)});
